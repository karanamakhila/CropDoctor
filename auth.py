...
class ResNet9(ImageClassificationBase):
    ...
    def forward(self, xb): 
        ...
        return out  
model = ResNet9(3,38)
PATH = 'C:/Users/karan/OneDrive/Documents/CropDoctor/Works/MY_home_login/plant-disease-model.pth'
...
def detect():
    if request.method=="POST":
        ...
        file_path=os.path.join(r'C:/Users/karan/OneDrive/Documents/CropDoctor/Works/MY_home_login/static',filename)
        file.save(file_path)
